...
public class HtmlRenderer extends Renderer {
   ...
   */
  public HtmlRenderer(Locale locale, DisplaySorter sorter,
      ServerApplication application) throws Exception {
    super(locale, sorter, application);
    this.renderer = new XmlRenderer(locale, sorter, application);
  }
  ...
  public Representation getRepresentation() {
    ...
    try {
      ...
      this.logger.error("Unable to transform into HTML", ex);
